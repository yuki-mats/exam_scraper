...
7. merge して `18_law_context_prepared` を `20_merged_1` に反映
8. `03_prompt_add_explanationText.md`
9. `04_prompt_link_questionSetId.md`
10. merge / prepare で `30_merged_2`、`40_convert`、`upload_to_firestore` を更新
...
対象:
- <単一なら list_group_id / 資格一括なら qualification_key>
- 一次情報は 02b の法令コンテキスト反映済みの 20_merged_1
- 必要時のみ 23_correctChoiceText_fixed と 00_source を参照
- 20_merged_1 に isLawRelated / lawGroundedExplanationNotNeeded がない場合は、03の前に02bを実行すること
