...
次の要素は、暗記プラスの問題として自然になるように整えます。

- 取得元に固有の場面設定、固有名詞、数値又は条件
- 問題文と選択肢の情報順序、主語、表現
- 解説の論理構成と日本語

単語を置き換えただけの文章は完成扱いにしません。一方、AWSサービス名、法令名、専門用語など、正確さのために必要な語句は無理に変更しません。変更文字数や類似率の数値基準も設けません。

公開前の機械チェックは、問題文全体、選択肢一式又は取得元の解説との完全一致を検出する最小限のものにします。自然さ、難易度、資格らしさ、正答の妥当性は既存の評価工程で確認します。
