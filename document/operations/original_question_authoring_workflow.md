...
問題文と選択肢は局所的な微修正にとどめ、変更後の内容を取得元の正答と解説に照らします。変更前後で正答、各選択肢の正誤、正答と誤答を分ける理由を維持します。後続の解説工程は、取得元の解説を材料として参照し、既存の解説方針に沿ってより分かりやすい独自解説へ再構成します。取得元の正答又は解説が公式資料と矛盾する疑いがある場合は、独自問題化で辻褄を合わせず、正答確認へ戻します。
