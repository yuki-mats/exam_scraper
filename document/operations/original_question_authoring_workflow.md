...
次の要素は、暗記プラスの問題として自然になるように必要な範囲で整えます。
...
単語を置き換えただけの問題文は完成扱いにしません。一方、AWSサービス名、法令名、専門用語など、正確さのために必要な語句は無理に変更しません。選択肢も、取得元と同じ内容を使うことが新しい問題文に対して自然で正確なら、差を作るためだけに書き換えません。変更文字数や類似率の数値基準も設けません。
