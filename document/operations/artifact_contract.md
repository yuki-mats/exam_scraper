...
| session run | `output/question_review_console/workflow_runs/<qualification>/<runId>/` | manifest、receipt、baseline、技術ログと、一問工程の`projected_inputs/<workItemKey>.json`・read-only準備結果。 |
