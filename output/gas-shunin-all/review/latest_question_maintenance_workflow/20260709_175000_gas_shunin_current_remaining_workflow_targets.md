...
- generatedAt: 2026-07-09T17:50:00+09:00
...
- machine-readable remaining targets: `output/gas-shunin-all/review/latest_question_maintenance_workflow/20260709_175000_gas_shunin_current_remaining_workflow_targets.jsonl`
...
- 二次検証済みレコード: 44 件
- 残対象レコード: 343 件
- 残対象の一意 queue item key: 294 件
- 残対象の重複 queue item key: 39 種類 / 追加行 49 件
...
| --- | ---: |
| `answer_recheck` | 28 |
| `lawzilla_law_evidence` | 257 |
| `source_conflict_review` | 126 |
...
| 63 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2022 | 問4 | `gasushunin-koushu-hourei-2022-4` | `` | lawzilla_law_evidence |
| 64 | P0 | `manual_review_required_partial_candidates` | `gas-shunin-kou` | 2022 | 問3 | `gasushunin-koushu-hourei-2022-3` | `` | lawzilla_law_evidence |
