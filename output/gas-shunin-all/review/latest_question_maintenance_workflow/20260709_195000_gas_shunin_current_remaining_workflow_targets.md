...
- machine-readable remaining targets: `output/gas-shunin-all/review/latest_question_maintenance_workflow/20260709_195000_gas_shunin_current_remaining_workflow_targets.jsonl`
...
| ---: | --- | --- | --- | ---: | --- | --- | --- | --- |
| 51 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2022 | 問16 | `gasushunin-koushu-hourei-2022-16` | `None` | lawzilla_law_evidence<br>source_conflict_review |
| 52 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2022 | 問15 | `gasushunin-koushu-hourei-2022-15` | `None` | lawzilla_law_evidence |
| 53 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2022 | 問14 | `gasushunin-koushu-hourei-2022-14` | `None` | lawzilla_law_evidence |
