...
- machine-readable remaining targets: `output/gas-shunin-all/review/latest_question_maintenance_workflow/20260709_193000_gas_shunin_current_remaining_workflow_targets.jsonl`
...
- 二次検証済みレコード: 49 件
- 残対象レコード: 338 件
- 残対象の一意 queue item key: 290 件
- 残対象の重複 queue item key: 38 種類 / 追加行 48 件
...
| --- | ---: |
| `answer_recheck` | 28 |
| `lawzilla_law_evidence` | 252 |
| `source_conflict_review` | 123 |
...
| 66 | P0 | `manual_review_required_partial_candidates` | `gas-shunin-kou` | 2022 | 問2 | `gasushunin-koushu-hourei-2022-2` | `正しい|正しい|正しい|正しい` | lawzilla_law_evidence<br>source_conflict_review |
