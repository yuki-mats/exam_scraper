...
- machine-readable remaining targets: `output/gas-shunin-all/review/latest_question_maintenance_workflow/20260709_155000_gas_shunin_current_remaining_workflow_targets.jsonl`
...
| --- | ---: |
| `answer_recheck` | 28 |
| `lawzilla_law_evidence` | 263 |
| `source_conflict_review` | 130 |
...
| `gas-shunin-kou` | 2023 | 12 | 2 | 17 | 31 |
