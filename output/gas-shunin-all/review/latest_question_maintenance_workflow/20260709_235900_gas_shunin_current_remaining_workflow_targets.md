...
- machine-readable remaining targets: `output/gas-shunin-all/review/latest_question_maintenance_workflow/20260709_235900_gas_shunin_current_remaining_workflow_targets.jsonl`
...
- 二次検証済みレコード: 61 件
- 残対象レコード: 326 件
- 残対象の一意 queue item key: 284 件
- 残対象の重複 queue item key: 32 種類 / 追加行 42 件
...
| --- | ---: |
| `answer_recheck` | 28 |
| `lawzilla_law_evidence` | 240 |
| `source_conflict_review` | 117 |
...
| 74 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問10 | `gasushunin-koushu-hourei-2021-10` | `None` | lawzilla_law_evidence<br>source_conflict_review |
| 75 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問9 | `gasushunin-koushu-hourei-2021-9` | `None` | lawzilla_law_evidence |
| 76 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問8 | `gasushunin-koushu-hourei-2021-8` | `None` | lawzilla_law_evidence<br>source_conflict_review |
| 77 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問7 | `gasushunin-koushu-hourei-2021-7` | `None` | lawzilla_law_evidence |
| 78 | P0 | `manual_review_required_partial_candidates` | `gas-shunin-kou` | 2021 | 問6 | `gasushunin-koushu-hourei-2021-6` | `None` | lawzilla_law_evidence<br>source_conflict_review |
| 79 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問5 | `gasushunin-koushu-hourei-2021-5` | `None` | lawzilla_law_evidence<br>source_conflict_review |
| 80 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問4 | `gasushunin-koushu-hourei-2021-4` | `None` | lawzilla_law_evidence<br>source_conflict_review |
| 81 | P0 | `manual_review_required_all_choices_have_primary_evidence` | `gas-shunin-kou` | 2021 | 問3 | `gasushunin-koushu-hourei-2021-3` | `None` | lawzilla_law_evidence<br>source_conflict_review |
