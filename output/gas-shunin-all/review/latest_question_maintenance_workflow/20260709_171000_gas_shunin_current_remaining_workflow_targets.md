...
- generatedAt: 2026-07-09T17:10:00+09:00
...
- machine-readable remaining targets: `output/gas-shunin-all/review/latest_question_maintenance_workflow/20260709_171000_gas_shunin_current_remaining_workflow_targets.jsonl`
...
- 残対象の重複 queue item key: 41 種類 / 追加行 51 件
...
| --- | ---: |
| `answer_recheck` | 28 |
| `lawzilla_law_evidence` | 259 |
| `source_conflict_review` | 127 |
...
| --- | ---: | --- |
| `gas-shunin-kou:2023:問7:` | 2 | 43, 266 |
