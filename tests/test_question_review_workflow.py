...
"""
    ...
    def test_dialog_controls_have_matching_javascript_handlers(self):
        ...
        self.assertIn('id="qualification-run-initial-model"', html)
        self.assertIn("policy.initialModelOptions", javascript)
        self.assertIn("initialModel: selectedQualificationRunInitialModel()", javascript)
        self.assertIn("initialModel: preview.initialModel", javascript)
        self.assertNotIn('name="qualification-run-reasoning"', html)
        self.assertNotIn('name="qualification-run-provider"', html)
